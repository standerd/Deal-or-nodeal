        ...
        return (
          <div className="helpScreen">
            ...
            <p>
              ...
              money then what you have in the suitcase that you selected. <br />
              <br />
              As the game progresses the bankers offer will change depending on
              the values that are in the remaining cases. <br />
              <br />
            ...
            <ol className="rulesUL">
              ...
              <li>
                On the second screen you will be shown a heading indicating how
              ...
              <li>
                Once the remaing suitcases reach 0, a page will display where
                the banker will offer you a sum of money for your suitcase.
              </li>
              <li>
                You can either accept his offer or reject his offer and continue
                with the game.
              </li>
              <li>
                The suitcases that you need to select will reduce in each round
                and be indicated in the heading.
              </li>
              <li>
                Once you reach only 1 case remaining and you still decline the
                bankers offer. You will win whatever value was contained inside
                the suitcase that you had selected.
              </li>
              <li>GOOD LUCK</li>
            </ol>
            <button className="exit" onClick={this.loadHelp}>
              BACK
            </button>
          </div>
        );
